/*
  ...
  1. New Tables
    ...
    - `user_top_artists` - Track user's top listened artists
    - `user_top_songs` - Track user's top listened songs
    - `user_status` - Custom showcase sections for users
    - `song_plays` - Detailed play tracking for analytics

  2. Security
    - Enable RLS on all new tables
    - Add comprehensive policies for privacy and access control
