/*
  ...
  1. New Tables
    ...
    - `user_top_artists` - User's top listened artists with play counts
    - `user_top_songs` - User's top listened songs with play counts
    - `user_status` - Custom showcase sections (status, pinned content)
  ...
  3. Functions
    ...
    - Admin statistics
    - User profile retrieval with stats
    - Play tracking and statistics updates
